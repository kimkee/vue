 ...
 * limitations under the License.
 */
class N{constructor(e){this.container=e}getPlatformInfoString(){const e=this.container.getProviders();return e.map((e=>{if(R(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null})).filter((e=>e)).join(" ")}}function R(e){const t=e.getComponent();return"VERSION"===(null===t||void 0===t?void 0:t.type)}const A="@firebase/app",O="0.9.0",P=new i.Yd("@firebase/app"),D="@firebase/app-compat",M="@firebase/analytics-compat",L="@firebase/analytics",F="@firebase/app-check-compat",U="@firebase/app-check",$="@firebase/auth",V="@firebase/auth-compat",j="@firebase/database",q="@firebase/database-compat",B="@firebase/functions",z="@firebase/functions-compat",H="@firebase/installations",G="@firebase/installations-compat",W="@firebase/messaging",K="@firebase/messaging-compat",Y="@firebase/performance",Q="@firebase/performance-compat",J="@firebase/remote-config",X="@firebase/remote-config-compat",Z="@firebase/storage",ee="@firebase/storage-compat",te="@firebase/firestore",ne="@firebase/firestore-compat",re="firebase",ie="9.15.0",se="[DEFAULT]",oe={[A]:"fire-core",[D]:"fire-core-compat",[L]:"fire-analytics",[M]:"fire-analytics-compat",[U]:"fire-app-check",[F]:"fire-app-check-compat",[$]:"fire-auth",[V]:"fire-auth-compat",[j]:"fire-rtdb",[q]:"fire-rtdb-compat",[B]:"fire-fn",[z]:"fire-fn-compat",[H]:"fire-iid",[G]:"fire-iid-compat",[W]:"fire-fcm",[K]:"fire-fcm-compat",[Y]:"fire-perf",[Q]:"fire-perf-compat",[J]:"fire-rc",[X]:"fire-rc-compat",[Z]:"fire-gcs",[ee]:"fire-gcs-compat",[te]:"fire-fst",[ne]:"fire-fst-compat","fire-js":"fire-js",[re]:"fire-js-all"},ae=new Map,le=new Map;function ce(e,t){try{e.container.addComponent(t)}catch(n){P.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function ue(e){const t=e.name;if(le.has(t))return P.debug(`There were multiple attempts to register component ${t}.`),!1;le.set(t,e);for(const n of ae.values())ce(n,e);return!0}function he(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
function Rh(e){e=au(e,fu);const t=au(e.firestore,Nu);return Iu(Au(t),e._key).then((n=>Fh(t,e,n)))}class Ah extends Th{constructor(e){super(),this.firestore=e}convertBytes(e){return new Pu(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new fu(this.firestore,null,t)}}function Oh(e){e=au(e,pu);const t=au(e.firestore,Nu),n=Au(t),r=new Ah(t);return ah(e._query),ku(n,e._query).then((n=>new xh(t,r,e,n)))}function Ph(e,t,n){e=au(e,fu);const r=au(e.firestore,Nu),i=Eh(e.converter,t,n);return Lh(r,[zu(Bu(r),"setDoc",e._key,i,null!==e.converter,n).toMutation(e._key,po.none())])}function Dh(e,t,n,...r){e=au(e,fu);const i=au(e.firestore,Nu),s=Bu(i);let o;return o="string"==typeof(t=(0,a.m9)(t))||t instanceof Du?Wu(s,"updateDoc",e._key,t,n,r):Gu(s,"updateDoc",e._key,t),Lh(i,[o.toMutation(e._key,po.exists(!0))])}function Mh(e){return Lh(au(e.firestore,Nu),[new ko(e._key,po.none())])}function Lh(e,t){return function(e,t){const n=new jr;return e.asyncQueue.enqueueAndForget((async()=>Lc(await Eu(e),t,n))),n.promise}(Au(e),t)}function Fh(e,t,n){const r=n.docs.get(t._key),i=new Ah(e);return new Ih(e,i,t._key,r,new Sh(n.hasPendingWrites,n.fromCache),t.converter)}
/**
 * @license
 * Copyright 2022 Google LLC
 *
...
//# sourceMappingURL=chunk-vendors.e6d84b85.js.map