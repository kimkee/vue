 ...
 * limitations under the License.
 */
class A{constructor(e){this.container=e}getPlatformInfoString(){const e=this.container.getProviders();return e.map((e=>{if(O(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null})).filter((e=>e)).join(" ")}}function O(e){const t=e.getComponent();return"VERSION"===(null===t||void 0===t?void 0:t.type)}const R="@firebase/app",N="0.9.0",D=new s.Yd("@firebase/app"),P="@firebase/app-compat",L="@firebase/analytics-compat",M="@firebase/analytics",F="@firebase/app-check-compat",U="@firebase/app-check",$="@firebase/auth",V="@firebase/auth-compat",j="@firebase/database",B="@firebase/database-compat",z="@firebase/functions",q="@firebase/functions-compat",G="@firebase/installations",H="@firebase/installations-compat",W="@firebase/messaging",K="@firebase/messaging-compat",J="@firebase/performance",Q="@firebase/performance-compat",X="@firebase/remote-config",Y="@firebase/remote-config-compat",Z="@firebase/storage",ee="@firebase/storage-compat",te="@firebase/firestore",ne="@firebase/firestore-compat",re="firebase",se="9.15.0",ie="[DEFAULT]",oe={[R]:"fire-core",[P]:"fire-core-compat",[M]:"fire-analytics",[L]:"fire-analytics-compat",[U]:"fire-app-check",[F]:"fire-app-check-compat",[$]:"fire-auth",[V]:"fire-auth-compat",[j]:"fire-rtdb",[B]:"fire-rtdb-compat",[z]:"fire-fn",[q]:"fire-fn-compat",[G]:"fire-iid",[H]:"fire-iid-compat",[W]:"fire-fcm",[K]:"fire-fcm-compat",[J]:"fire-perf",[Q]:"fire-perf-compat",[X]:"fire-rc",[Y]:"fire-rc-compat",[Z]:"fire-gcs",[ee]:"fire-gcs-compat",[te]:"fire-fst",[ne]:"fire-fst-compat","fire-js":"fire-js",[re]:"fire-js-all"},ae=new Map,le=new Map;function ce(e,t){try{e.container.addComponent(t)}catch(n){D.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function ue(e){const t=e.name;if(le.has(t))return D.debug(`There were multiple attempts to register component ${t}.`),!1;le.set(t,e);for(const n of ae.values())ce(n,e);return!0}function he(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Be(e,t){return L(e,"POST","/v1/accounts:sendVerificationCode",P(e,t))}async function ze(e,t){return F(e,"POST","/v1/accounts:signInWithPhoneNumber",P(e,t))}async function qe(e,t){const n=await F(e,"POST","/v1/accounts:signInWithPhoneNumber",P(e,t));if(n.temporaryProof)throw V(e,"account-exists-with-different-credential",n);return n}const Ge={["USER_NOT_FOUND"]:"user-not-found"};async function He(e,t){const n=Object.assign(Object.assign({},t),{operation:"REAUTH"});return F(e,"POST","/v1/accounts:signInWithPhoneNumber",P(e,n),Ge)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lo=new yi(os.comparator);function Mo(){return Lo}const Fo=new yi(os.comparator);function Uo(...e){let t=Fo;for(const n of e)t=t.insert(n.key,n);return t}function $o(e){let t=Fo;return e.forEach(((e,n)=>t=t.insert(e,n.overlayedDocument))),t}function Vo(){return Bo()}function jo(){return Bo()}function Bo(){return new Po((e=>e.toString()),((e,t)=>e.isEqual(t)))}const zo=new yi(os.comparator),qo=new _i(os.comparator);function Go(...e){let t=qo;for(const n of e)t=t.add(n);return t}const Ho=new _i(Yr);function Wo(){return Ho}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class za{constructor(e){this.ie=e}}function qa(e){const t=Ca({parent:e.parent,structuredQuery:e.structuredQuery});return"LAST"===e.limitType?Bi(t,t.limit,"L"):t}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function Ah(e){e=au(e,fu);const t=au(e.firestore,Au);return Iu(Ru(t),e._key).then((n=>Fh(t,e,n)))}class Oh extends Eh{constructor(e){super(),this.firestore=e}convertBytes(e){return new Du(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new fu(this.firestore,null,t)}}function Rh(e){e=au(e,pu);const t=au(e.firestore,Au),n=Ru(t),r=new Oh(t);return ah(e._query),ku(n,e._query).then((n=>new kh(t,r,e,n)))}function Nh(e,t,n){e=au(e,fu);const r=au(e.firestore,Au),s=Th(e.converter,t,n);return Mh(r,[qu(zu(r),"setDoc",e._key,s,null!==e.converter,n).toMutation(e._key,po.none())])}function Dh(e,t,n,...r){e=au(e,fu);const s=au(e.firestore,Au),i=zu(s);let o;return o="string"==typeof(t=(0,a.m9)(t))||t instanceof Pu?Wu(i,"updateDoc",e._key,t,n,r):Hu(i,"updateDoc",e._key,t),Mh(s,[o.toMutation(e._key,po.exists(!0))])}function Ph(e){return Mh(au(e.firestore,Au),[new ko(e._key,po.none())])}function Lh(e,t){const n=au(e.firestore,Au),r=vu(e),s=Th(e.converter,t);return Mh(n,[qu(zu(e.firestore),"addDoc",r._key,s,null!==e.converter,{}).toMutation(r._key,po.exists(!1))]).then((()=>r))}function Mh(e,t){return function(e,t){const n=new jr;return e.asyncQueue.enqueueAndForget((async()=>Mc(await Su(e),t,n))),n.promise}(Ru(e),t)}function Fh(e,t,n){const r=n.docs.get(t._key),s=new Oh(e);return new Ch(e,s,t._key,r,new Sh(n.hasPendingWrites,n.fromCache),t.converter)}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * limitations under the License.
 */
class Be{constructor(e,t){this._service=e,this._location=t instanceof R?t:R.makeFromUrl(t,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,t){return new Be(e,t)}get root(){const e=new R(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return me(this._location.path)}get storage(){return this._service}get parent(){const e=pe(this._location.path);if(null===e)return null;const t=new R(this._location.bucket,e);return new Be(this._service,t)}_throwIfRoot(e){if(""===this._location.path)throw x(e)}}function ze(e,t,n){e._throwIfRoot("uploadBytes");const r=Fe(e.storage,e._location,_e(),new de(t,!0),n);return e.storage.makeRequestWithTokens(r,je).then((t=>({metadata:t,ref:e})))}function qe(e){e._throwIfRoot("getDownloadURL");const t=De(e.storage,e._location,_e());return e.storage.makeRequestWithTokens(t,je).then((e=>{if(null===e)throw S();return e}))}function Ge(e){e._throwIfRoot("deleteObject");const t=Pe(e.storage,e._location);return e.storage.makeRequestWithTokens(t,je)}function He(e,t){const n=ge(e._location.path,t),r=new R(e._location.bucket,n);return new Be(e.storage,r)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
