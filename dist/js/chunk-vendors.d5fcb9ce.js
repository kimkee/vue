 ...
 * limitations under the License.
 */
function Rh(t){t=al(t,fl);const e=al(t.firestore,Rl);return Sl(Nl(e),t._key).then((n=>Mh(e,t,n)))}class Oh extends Eh{constructor(t){super(),this.firestore=t}convertBytes(t){return new xl(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new fl(this.firestore,null,e)}}function Nh(t){t=al(t,pl);const e=al(t.firestore,Rl),n=Nl(e),r=new Oh(e);return ah(t._query),Cl(n,t._query).then((n=>new Ch(e,r,t,n)))}function Dh(t,e,n,...r){t=al(t,fl);const i=al(t.firestore,Rl),s=$l(i);let o;return o="string"==typeof(e=(0,a.m9)(e))||e instanceof Ll?Kl(s,"updateDoc",t._key,e,n,r):Gl(s,"updateDoc",t._key,e),Ph(i,[o.toMutation(t._key,po.exists(!0))])}function xh(t){return Ph(al(t.firestore,Rl),[new Co(t._key,po.none())])}function Lh(t,e){const n=al(t.firestore,Rl),r=yl(t),i=Th(t.converter,e);return Ph(n,[zl($l(t.firestore),"addDoc",r._key,i,null!==t.converter,{}).toMutation(r._key,po.exists(!1))]).then((()=>r))}function Ph(t,e){return function(t,e){const n=new qr;return t.asyncQueue.enqueueAndForget((async()=>Mu(await Il(t),e,n))),n.promise}(Nl(t),e)}function Mh(t,e,n){const r=n.docs.get(e._key),i=new Oh(t);return new kh(t,i,e._key,r,new Ih(n.hasPendingWrites,n.fromCache),e.converter)}
/**
 * @license
 * Copyright 2022 Google LLC
 *
...
//# sourceMappingURL=chunk-vendors.d5fcb9ce.js.map